; ModuleID = 'c/factorial.c'
source_filename = "c/factorial.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.12.0"

@.str = private unnamed_addr constant [29 x i8] c"give-me a positive integer:\0A\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@x = common global i32 0, align 4
@.str.2 = private unnamed_addr constant [22 x i8] c"factorial of %d = %d\0A\00", align 1

; Function Attrs: nounwind ssp uwtable
define i32 @fat(i32) #0 {
...
define i32 @main() #0 {
  ...
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32* @x)
  %4 = load i32, i32* @x, align 4
  %5 = load i32, i32* @x, align 4
  %6 = call i32 @fat(i32 %5)
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2, i32 0, i32 0), i32 %4, i32 %6)
  ret i32 0
}
