; ModuleID = 'c/example1.c'
source_filename = "c/example1.c"
...
define i32 @main() #0 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i32* %2, i32* %3)
...
; <label>:10:                                     ; preds = %6
  ...
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 %16, i32 %17)
